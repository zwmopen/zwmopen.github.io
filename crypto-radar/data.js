...
const PLATFORM_INFO={
 ...
 bitget:{name:'Bitget',users:'1.2 亿+',tag:'ELITE TRADER',summary:'公开 Elite Trader 排行体系覆盖 Futures、Spot、CFD。榜单和交易员卡片可查看 ROI、跟单人数等指标，部分商品页还会给出热门精英交易员。',status:'公开榜单已确认',leaderboards:[['Futures Elite Trader','合约精英交易员榜'],['Spot Elite Trader','现货精英交易员榜'],['CFD Elite Trader','CFD / MT5 精英交易员榜']],metrics:['30天 ROI','当前跟单人数','账户利润','交易员等级/分润'],links:[['Copy Trading','https://www.bitget.com/copy-trading'],['榜单规则','https://www.bitget.com/support/articles/12560603885593'],['Elite Trader 指南','https://www.bitget.com/support/articles/12560603847588']]},
  bybit:{name:'Bybit',users:'0.8 亿+',tag:'MASTER TRADER',summary:'Bybit 有公开 Copy Trading Leaderboard；本站采集在不同区域可能受 HTTP/2 限制，未取得可验证用户快照时只保留官方榜入口。',status:'官方榜已确认 · 本站用户快照待接入',leaderboards:[['Top Balanced Traders','收益与风险更均衡'],['Top ROI','高 ROI 交易员'],['Top Intra-Day Traders','日内交易员'],['Top New Talents','新晋交易员'],['Highest Follower Profit','跟随者利润高'],['Lowest Drawdown','低回撤']],metrics:['30天 ROI','Master PnL','最大回撤','Follower Profit','交易统计与持仓'],links:[['官方 Copy Trading Leaderboard','https://www.bybit.com/copyTrading/en/leader-board'],['绩效说明','https://www.bybitglobal.com/en/help-center/article/How-to-Understand-Master-Trader-Performance'],['排行规则','https://www.bybitglobal.com/en/help-center/article/How-Can-Master-Traders-Rank-in-The-Different-Categories']]},
  gate:{name:'Gate',users:'0.50 亿+',tag:'LIVE COPY TRADING',summary:'Gate 有实时跟单交易员排行榜规则；本站采集在不同区域可能被限制，未取得可验证用户快照时只保留官方榜入口。',status:'官方榜已确认 · 本站用户快照待接入',leaderboards:[['Daily Ranking','每日更新前一日排名'],['Monthly Ranking','每月 1 日更新'],['Whale Ranking','偏资产规模维度'],['Copy Profit / Follower Growth','活动榜中也公开过利润与粉丝增长榜']],metrics:['收益率 30% 权重','累计利润 30%','最大回撤 10%','资产规模 30%'],links:[['官方 Copy Trading','https://www.gate.com/copytrading'],['实时榜规则','https://www.gate.com/de/help/quants/traders_guide/40122/copy-trading-lead-traders-leaderboard-rules'],['榜单示例','https://www.gate.com/campaigns/3501']]},
  kucoin:{name:'KuCoin',users:'0.45 亿+',tag:'LEAD TRADER',summary:'KuCoin 当前公开榜可取得 12 位用户，但头像仅覆盖 3/12、稳定用户主页链接为 0/12；页面会明确显示这项不完整性。',status:'官方榜已接入 · 信息不完整',leaderboards:[['7 / 30 / 90 天表现','多周期交易员表现'],['ROI / PNL','收益率与收益额'],['Follower PNL','跟随者累计收益'],['Trade Size / Followers','交易规模与当前跟随人数']],metrics:['PNL / PNL%','AUM','Lead Trading Principal','交易频率','持仓时长','偏好资产','当前/历史持仓'],links:[['官方 Copy Trading','https://www.kucoin.com/copytrading'],['Lead Trader 指南','https://www.kucoin.com/support/39211647234969'],['Copy Trading 介绍','https://www.kucoin.com/support/38990860166041']]},
